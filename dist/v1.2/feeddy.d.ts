 ...
 * @template R - The route type (summary or full)
 */
type ByIdPostsOptions<R extends FeedRoute = FeedRoute> = FeedByIdOptions<"posts", R>;
/**
 * The options for configuring a summary blog posts feed request by ID.
 */
type ByIdPostsOptionsSummary = FeedByIdOptions<"posts", "summary">;
 ...
 * @template R - The route type (summary or full)
 */
type ByIdCommentsOptions<R extends FeedRoute = FeedRoute> = InnerFeedOptions<CommentsFeedOptions<R>> & WithId;
/**
 * The options for configuring a summary blog comments feed request by ID.
 */
type ByIdCommentsOptionsSummary = InnerFeedOptions<CommentsFeedOptionsSummary> & WithId;
/**
 ...
 * @template R - The route type (summary or full)
 */
type ByIdPagesOptions<R extends FeedRoute = FeedRoute> = FeedByIdOptions<"pages", R>;
/**
 * The options for configuring a summary blog pages feed request by ID.
 */
type ByIdPagesOptionsSummary = FeedByIdOptions<"pages", "summary">;
